		...
		public function __get($key)
		{
			switch($key){
				case 'ip':
					...
					$this->ip = null;
					foreach($keys as $key){
						if(isset($_SERVER[$key]) and $_SERVER[$key]){
							$this->ip = $_SERVER[$key];
							break;
						}
					}
